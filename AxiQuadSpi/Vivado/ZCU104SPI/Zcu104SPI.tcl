...
#
# Zcu104SPI.tcl: Tcl script for re-creating project 'Zcu104SPI'
#
# Generated by Vivado on Thu May 04 11:11:30 IDT 2023
...
#
# 1. This project restoration tcl script (Zcu104SPI.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/dan/Petalinux/Vivado/2022.2/Zcu104SPI/Zcu104SPI.srcs/constrs_1/new/zcu104.xdc"
#    "/home/dan/Petalinux/Vivado/2022.2/Zcu104SPI/Zcu104SPI.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "constrains/zcu104.xdc"]"\
 "[file normalize "$origin_dir/hdl/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set orig_proj_dir "[file normalize "$origin_dir/../Zcu104SPI"]"
...
set file "[file normalize "$origin_dir/constrains/zcu104.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/zcu104.xdc"
...
\
    ...
    CONFIG.PSU__CRL_APB__QSPI_REF_CTRL__ACT_FREQMHZ {1.000000} \
    CONFIG.PSU__CRL_APB__QSPI_REF_CTRL__FREQMHZ {1} \
...
\
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins axi_quad_spi_0/AXI_LITE] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.675378",
   "Default View_TopLeft":"-262,-166",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port spi_rtl -pg 1 -lvl 4 -x 1260 -y 270 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 320 -y 90 -defaultsOSRD
preplace inst axi_quad_spi_0 -pg 1 -lvl 3 -x 1110 -y 280 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 2 -x 810 -y 150 -defaultsOSRD
preplace inst rst_ps8_0_100M -pg 1 -lvl 1 -x 320 -y 290 -defaultsOSRD
preplace netloc axi_quad_spi_0_ip2intc_irpt 1 0 4 0 180 620J 300 950J 190 1240
preplace netloc rst_ps8_0_100M_peripheral_aresetn 1 1 2 640 310 NJ
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 -10 390 630 320 960
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 2 0 190 610
preplace netloc axi_quad_spi_0_SPI_0 1 3 1 N 270
preplace netloc ps8_0_axi_periph_M00_AXI 1 2 1 960 150n
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 1 1 N 60
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM1_FPD 1 1 1 N 80
levelinfo -pg 1 -30 320 810 1110 1260
pagesize -pg 1 -db -bbox -sgen -30 0 1360 610
"
}
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/Zcu104SPI.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp" -objects $obj
